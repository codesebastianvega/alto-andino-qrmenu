...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-[#1A1A1A] font-sans selection:bg-[#E6B05C] selection:text-white relative overflow-hidden">
      <style>
        {`
      ...
      <nav className={`fixed z-40 transition-all duration-300 ease-out flex justify-between items-center ${
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold tracking-tight">Alto Andino</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1.5 bg-white border border-black/5 text-[#1A1A1A] px-3 py-1.5 rounded-full hover:bg-black/5 transition-colors cursor-pointer font-bold text-[11px]">
            <ShoppingBag size={12} />
            <span className="hidden sm:inline">Pedido</span>
          </div>
          <div className="flex items-center gap-1.5 bg-[#1A1A1A] text-white pl-1.5 pr-3 py-1 rounded-full shadow-sm cursor-pointer">
            <div className="w-5 h-5 bg-white/20 text-white rounded-full flex items-center justify-center"><User size={10} /></div>
            <span className="text-[11px] font-bold hidden sm:inline">Mi Cuenta</span>
          </div>
        </div>
      </nav>

      {/* 🎯 MAIN CONTENT */}
      <main className="relative z-10 pt-32 pb-20 px-6 lg:px-8 container mx-auto max-w-3xl flex flex-col items-center">
          ...
          <motion.div variants={itemVariants} className="flex flex-col items-center mb-10 text-center">
            <div className="relative mb-4">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#1A2421] to-[#2c3d38] p-1 shadow-xl">
                <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=200" alt="Perfil" className="w-full h-full rounded-full object-cover border-4 border-white" />
              </div>
