          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-8 lg:p-12 custom-scrollbar">
                  ...
                  return (
                    <div key={plan.id}
                      className={`relative flex flex-col rounded-3xl border transition-all duration-300 ${
                        plan.highlight 
                          ? 'bg-white/[0.03] border-brand-primary/40 scale-[1.02] shadow-[0_0_40px_rgba(0,0,0,0.1)]' 
                    ...
                    >
                      ...
                      <div className="flex-1 px-6 space-y-3.5 mb-8">
                        {plan.features.map((feature, idx) => (
                          <div key={`${plan.id}-feat-${idx}`} className="flex items-start gap-3">
              ...
              <div className="mt-12 p-6 rounded-[24px] bg-gradient-to-r from-brand-primary/10 to-blue-500/10 border border-white/10 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <button 
                  type="button"
                  className="px-6 py-3 bg-white/10 hover:bg-white/20 text-white text-sm font-bold rounded-xl transition-all border border-white/10"
                >
                  Saber más sobre IA
                </button>
              </div>
