...
/** Text input */
export function TextInput({ value, onChange, placeholder, type = 'text', required, name, className = '', ...props }) {
  return (
    <input
      type={type}
      required={required}
  ...
  return (
    <button
      ...
      className={`
        ...
        transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#2f4131] focus:ring-offset-2
        ${checked ? 'bg-[#2f4131]' : 'bg-gray-200'}
...
/** 
 * Helper component for image upload guidance
 */
